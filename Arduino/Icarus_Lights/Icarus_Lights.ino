...
void sparkle(long time)
{
  ...
  do
  {
    ...
    {
      for(i=0; i<sizeof(intensity); i+= 3)
      {
        strip.setPixelColor(i, 0, 0, intensity[i]);
      }
      
      for(i=1; i<sizeof(intensity); i+= 3)
      {
        strip.setPixelColor(i, intensity[i], 0, 0);
      }
      
      for(i=2; i<sizeof(intensity); i+= 3)
      {
  ...
  do
  {
    for(i=0; i<strip.numPixels(); i++)
    {
      switch(random(6))
      {
        ...
        case 1: strip.setPixelColor(i, allianceColor); break;
        case 2: strip.setPixelColor(i, 0, 0, 0); break;
        case 3: strip.setPixelColor(i, allianceColor); break;
